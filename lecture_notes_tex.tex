...
\ifx\fourteenpoint\undefined
   \def\fourteenpoint{\def\rm{\fam0\fourteenrm}% switch to 14-point type
       ...
       \normalbaselines\rm}
   \fi
%%%% end of font size macro

\fourteenpoint

%%%% therefore and because symbol
\def\thfr{.\raise.75ex\hbox{.}.}
\def\bcaus{\raise.75ex\hbox{.}.\raise.75ex\hbox{.}}
